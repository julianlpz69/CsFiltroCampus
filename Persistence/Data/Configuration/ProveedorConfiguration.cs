...
namespace Persistence.Data.Configuration
{
    public class ProveedorConfiguration : IEntityTypeConfiguration<Proveedor>
    {
        public void Configure(EntityTypeBuilder<Proveedor> builder){
            ...
            builder.HasData(
              new Proveedor  {Id = 1, IdMunicipioFk = 1, IdTipoPersonaFK = 2, NitProveedor = "1002312", NombreProveedor = "Ropa la 15"},
              new Proveedor  {Id = 2, IdMunicipioFk = 2, IdTipoPersonaFK = 2, NitProveedor = "1007766", NombreProveedor = "LA ropera"},
              new Proveedor  {Id = 3, IdMunicipioFk = 3, IdTipoPersonaFK = 2, NitProveedor = "1005432", NombreProveedor = "La ropita"},
